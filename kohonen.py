...
class KohonenMap(Module):
    ...
    def _forwardImplementation(self, inbuf, outbuf):
        ...
        self.difference = self.neurons - \
            tile(inbuf, (self.nNeurons, self.nNeurons, 1))
    ...
    def _backwardImplementation(self, outerr, inerr, outbuf, inbuf):
        ...
        tempm = 1 - \
            sum(abs(self.distmatrix - self.winner.reshape(1, 1, 2)), 2) / \
            self.nNeurons
        tempm[tempm < 0] = 0
        ...
        self.neurons[tl[0]:br[0], tl[1]:br[1]] -= self.learningrate * \
            self.difference[tl[0]:br[0], tl[1]:br[1]] * \
            distm[tl[0]:br[0], tl[1]:br[1]]
